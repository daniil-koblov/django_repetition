"""
Django settings for project_for_lectures project.
...
SECRET_KEY = 'django-insecure-rnl_a$5)1!)nqlc!9942$k=+ij)(ha!px3^8&12!j^#*$+lcg@'
...
ROOT_URLCONF = 'project_for_lectures.urls'
...
WSGI_APPLICATION = 'project_for_lectures.wsgi.application'
